...
### Added
- Phase 7 (7.0.0) scaffolding: RiskManager placeholder and minimal unit test.
- .env.example: add RISK_* placeholders.

### Note
- No runtime behavior change yet; enforcement arrives in 7.1.x.
`------------------------------------------------------------------------------------------------`
